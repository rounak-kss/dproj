...
@Component({
  selector: 'app-fees-particular',
  templateUrl: './fees-particular.component.html',
  styleUrls: ['./fees-particular.component.css']
})
export class FeesParticularComponent implements OnInit {
